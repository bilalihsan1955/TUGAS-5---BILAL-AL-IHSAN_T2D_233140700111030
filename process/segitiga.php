      ...
      <div class="card-form">
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-5 text-center mb-4 mb-md-0">
            <img src="../assets/img/Triangle.png" alt="Nature">
          </div>
          <div class="col-md-7">
            <form method="post">
              <h1 class="mb-4 fw-bold text-dark fs-2 text-start">Luas Segitiga</h1>
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Alas</label>
                <input type="number" name="alas" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="masukkan alas" required>
              </div>
              <div class="mb-3">
