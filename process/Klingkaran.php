            ...
            <div class="card-form">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-md-5 text-center mb-4 mb-md-0">
                        <img src="../assets/img/Circlediameter.png" alt="Nature">
                    </div>
                    <div class="col-md-7">
                        <form method="post">
                            <h1 class="mb-4 fw-bold text-dark fs-2 text-start">Keliling Lingkaran</h1>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Diameter</label>
                                <input type="number" name="d" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="masukkan diameter  " required>
                            </div>
                            <label class="form-label">
                                ...
                                if (isset($_POST['hitung'])) {
                                    ...
                                    echo "Hasil keliling lingkaran = " . $output;
                                }
                                ?>
                            </label><br>
