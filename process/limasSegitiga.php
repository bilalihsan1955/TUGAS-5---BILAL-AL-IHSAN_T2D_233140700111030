        ...
        <div class="container-fluid">
            ...
            <div class="card-form">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-md-7">
                        <form method="post">
                            <h1 class="mb-4 fw-bold text-dark fs-2 text-start">Volume Limas Segitiga</h1>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Luas Alas</label>
                                <input type="number" name="alas" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="masukkan luas alas" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <label class="form-label">
                                ...
                                if (isset($_POST['hitung'])) {
                                    ...
                                    echo "Hasil Volume Limas Segitiga = " . $luas;
                                }
                                ?>
                            </label><br>
